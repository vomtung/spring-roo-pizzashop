...
static {
  ...
  private boolean _jspx_meth_util_panel_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_util_panel_0.setTitle((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:escapeXml(title_msg)}", java.lang.String.class, (PageContext)this.getJspContext(), _jspx_fnmap_1));
    _jspx_th_util_panel_0.setId((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:escapeXml(id)}", java.lang.String.class, (PageContext)this.getJspContext(), _jspx_fnmap_1));
    _jspx_th_util_panel_0.setJspBody(new dependency_tagxHelper( 0, _jspx_page_context, _jspx_th_util_panel_0, null));
  ...
  private boolean _jspx_meth_spring_message_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_spring_message_2.setCode("entity_dependency_required");
  ...
  private boolean _jspx_meth_c_forEach_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setVar("dependency");
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${dependencies}", java.lang.Object.class, (PageContext)this.getJspContext(), null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("<p>");
          if (_jspx_meth_field_reference_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
            return true;
          out.write("</p>");
  ...
  private boolean _jspx_meth_field_reference_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
          throws Throwable {
    JspWriter out = _jspx_page_context.getOut();
    //  field:reference
    ...
    _jspx_th_field_reference_0.setParent(_jspx_th_c_forEach_0);
    _jspx_th_field_reference_0.setPath((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/${dependency[1]}", java.lang.String.class, (PageContext)this.getJspContext(), null));
    _jspx_th_field_reference_0.setId((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:escapeXml(id)}_${dependency[0]}", java.lang.String.class, (PageContext)this.getJspContext(), _jspx_fnmap_1));
    _jspx_th_field_reference_0.setField((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${dependency[0]}", java.lang.String.class, (PageContext)this.getJspContext(), null));
    _jspx_th_field_reference_0.doTag();
    return false;
  }

  private class dependency_tagxHelper
